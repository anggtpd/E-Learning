      ...
      body: Stack(
        children: [
                  ...
                  IconButton(
                    icon: Assets.icons.arrowLeft.svg(
                        colorFilter: ColorFilter.mode(
                            AppColors.current.otherWhite, BlendMode.srcIn)),
          ...
          if (_showOverlay && _isFullscreen && !empty(widget.title))
            Positioned(
                ...
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Assets.icons.arrowDownLight2.svg(
              ...
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                            blurRadius: 8, color: Colors.white.withOpacity(0.8))
                      ]),
                  child: Icon(
          ...
          if (_showOverlay)
            Positioned(
              bottom:
                  _isFullscreen ? 15 : MediaQuery.sizeOf(context).height / 3,
